...
HD_PWD='C:/Users/cresp/FPGA_Projects/UART_proj/UART_proj.runs/Uart_xadc_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_xadc_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_xadc_clk_wiz_1_0.tcl
